    ...
    router.get('/create', async (req,res) => {
        try {
            await pool.query(`
                ...
                CREATE TABLE Voucher(ID_Voucher VARCHAR(10) PRIMARY KEY, Ten VARCHAR(100), QRCode VARCHAR(300), HinhAnh VARCHAR(300), TriGia INT, MoTa TEXT, NgayHetHan TIMESTAMP WITHOUT TIME ZONE, TrangThai BOOL, ID_ThuongHieu VARCHAR(10), CONSTRAINT FK_Voucher_ThuongHieu FOREIGN KEY (ID_ThuongHieu) REFERENCES ThuongHieu(ID_ThuongHieu)); 

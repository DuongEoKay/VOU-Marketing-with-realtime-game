...
module.exports = (pool) => {
    ...
    router.get('/create', async (req,res) => {
        try {
            await pool.query(`
                ...
                CREATE TABLE SuKien(ID_SuKien VARCHAR(10) PRIMARY KEY, ID_ThuongHieu VARCHAR(10), TenSuKien VARCHAR(100), HinhAnh VARCHAR(300), SoLuongVoucher INT, ThoiGianBatDau TIMESTAMP WITH TIME ZONE, ThoiGianKetThuc TIMESTAMP WITH TIME ZONE, CONSTRAINT FK_SuKien_ThuongHieu FOREIGN KEY (ID_ThuongHieu) REFERENCES ThuongHieu (ID_ThuongHieu));
                CREATE TABLE Voucher(ID_Voucher VARCHAR(10) PRIMARY KEY, Ten VARCHAR(100), QRCode VARCHAR(300), HinhAnh VARCHAR(300), TriGia INT, MoTa VARCHAR(300), NgayHetHan TIMESTAMP WITH TIME ZONE, TrangThai BOOL, ID_ThuongHieu VARCHAR(10), CONSTRAINT FK_Voucher_ThuongHieu FOREIGN KEY (ID_ThuongHieu) REFERENCES ThuongHieu(ID_ThuongHieu)); 
    ...
    router.get('/insert', async (req,res) => {
        try {
            await pool.query(`INSERT INTO ThuongHieu VALUES ('ID00000001', N'Aquafina', '0123456789', '123', 'https://rubicmarketing.com/wp-content/uploads/2022/12/logo-aquafina.jpg', N'Nước giải khát', N'123 Nguyễn Văn Cừ, Quận 5, TP.HCM', '106 0 22’ – 106 054 ’', '10 0 10’ – 10 0 38', true);`)
